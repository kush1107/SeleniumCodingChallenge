...
public class WaitForDownloadFile {
    ...
    public void setup()
    {
        ...
        driver.get("https://www.oracle.com/in/java/technologies/downloads/#jdk22-windows");
    ...
    public void WaitDownloadFileTest()
    {
       ...
       WebElement downLoadLink = new WebDriverWait(driver,Duration.ofSeconds(5)).until(ExpectedConditions
                .elementToBeClickable(By.xpath("//a[@href='https://download.oracle.com/java/22/latest/jdk-22_windows-x64_bin.msi']")));
        downLoadLink.click();
